...
CREATE TABLE `cliente` (
                           ...
                           `PREFERENCIA` varchar(11) DEFAULT NULL,
...
CREATE TABLE `empleado` (
                            ...
                            CONSTRAINT `FK_ES` FOREIGN KEY (`SUCURSAL`) REFERENCES `Sucursal` (`ID_SUCURSAL`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finca` (
                         ...
                         CONSTRAINT `FK_FP` FOREIGN KEY (`PROPIETARIO`) REFERENCES `Propietario` (`ID_PROPIETARIO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `visita` (
                          ...
                          CONSTRAINT `FK_VC` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `Cliente` (`ID_CLIENTE`),
                          CONSTRAINT `FK_VF` FOREIGN KEY (`ID_FINCA`) REFERENCES `Finca` (`ID_FINCA`),
                          CONSTRAINT `FK_VE` FOREIGN KEY (`ID_EMPLEADO`) REFERENCES `Empleado` (`ID_EMPLEADO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `captacion` (
                             ...
                             CONSTRAINT `FK_CAF` FOREIGN KEY (`ID_FINCA`) REFERENCES `Finca` (`ID_FINCA`),
                             CONSTRAINT `FK_CAE` FOREIGN KEY (`ID_EMPLEADO`) REFERENCES `Empleado` (`ID_EMPLEADO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
